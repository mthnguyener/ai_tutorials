...
from ai_tutorials.pkg_globals import PACKAGE_ROOT
...
class ComposeConfiguration:
    ...
    def __init__(self, filepath: Optional[Path] = None):
        ...
        self._container_prefix = (
            self._config['services'][f'{PROJECT_NAME}_python']
            ['container_name'].rsplit('_', 1)[0])
    ...
    def _add_ai_tutorials_latex(self):
    ...
    def _add_ai_tutorials_mongo(self):
    ...
    def _mongo_ai_tutorials_create_user_js(self):
    ...
    def _add_ai_tutorials_nginx(self):
    ...
    def _add_ai_tutorials_postgres(self):
    ...
    def _add_ai_tutorials_pgadmin(self):
    ...
    def _add_ai_tutorials_streamlit(self):
        ...
        self._config['services'][f'{PROJECT_NAME}_streamlit'] = {
            ...
            'volumes': [
                ...
                f'/usr/src/ai_tutorials/applications/streamlit',
            ],
        }
